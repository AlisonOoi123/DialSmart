...
# Set USE_MYSQL to False temporarily to read from SQLite
...
print("\n" + "="*70)
print("DialSmart: SQLite to MySQL Migration")
print("="*70)
...
# Step 2: Switch to MySQL and create tables
print("\n[2/3] Connecting to MySQL and creating tables...")

# Now switch to MySQL
os.environ['USE_MYSQL'] = 'true'

# Reload app with MySQL configuration
from app import create_app as create_app_mysql
from app import db as mysql_db

app_mysql = create_app_mysql()
...
with app_mysql.app_context():
    try:
        ...
        print("\nNext steps:")
        print("  1. Update config.py: Set USE_MYSQL = True")
